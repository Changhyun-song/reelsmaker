...
class FrameSpec(TimestampMixin, Base):
    ...
    subject_position: Mapped[str | None] = mapped_column(String(200), nullable=True)
    camera_angle: Mapped[str | None] = mapped_column(String(200), nullable=True)
    lens_feel: Mapped[str | None] = mapped_column(String(200), nullable=True)
